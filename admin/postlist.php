...
<div class="grid_10">
    <div class="box round first grid">
        ...
        <?php
            $query = "select table_post. *, table_category.name from table_post
            inner join table_category
            on table_post.category = table_category.id
...
<?php
    if (Session::get('userRole') == $result['userid'] || Session::get('userRole') == '0') { ?>
